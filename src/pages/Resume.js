      ...
      <><div className="md:w-1/3 p-2">
                <div className="">
                    <div className="md:block">
                        ...
                        <div className="mb-12 text-center mt-4 justify-center items-center">
                            ...
                            <div className="text-gray-600 md:hidden mt-1">
                                (Josedavidsanchezsantos@gmail.com)
                            </div>
                        </div>
                    </div>
                    <div className="mx-4 my-4 hidden md:block">
                        ...
                        <a
                            href="https://www.linkedin.com/in/jos%C3%A9-david-s%C3%A1nchez-santos-4931a9190"
                            ...
                            <li className="mb-4">
                                ...
                                <div className="mt-1">
                                    ...
                                    <div>
                                        ...
                                        <small className="text-sm text-gray-600">August 2021 - Present                 </small>
                                    </div>
                                </div>
                            </li>
